...
export default function RegisterPage() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Aqui poderíamos redirecionar para o checkout do Asaas ou para o login
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-4xl w-full grid grid-cols-1 lg:grid-cols-5 bg-white rounded-[32px] shadow-2xl shadow-slate-200 overflow-hidden border border-slate-100">
        ...
        <div className="lg:col-span-2 bg-blue-600 p-8 lg:p-12 text-white relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-blue-100 mb-12 leading-relaxed">
              Você está a poucos passos de profissionalizar sua gestão de consignados.
            </p>
        ...
        <div className="lg:col-span-3 p-8 lg:p-12 overflow-y-auto max-h-[90vh]">
          {step === 1 && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      placeholder="Ex: Joias do Sol LTDA" 
                      className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm font-mono"
                    />
                ...
                <div className="space-y-1.5">
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm"
                  />
                </div>
              </div>
              ...
              <button 
                ...
                className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white font-bold py-4 rounded-2xl transition-all shadow-lg shadow-blue-100"
              >
                Próximo Passo
                <ArrowRight size={20} />
              </button>
          ...
          {step === 2 && (
            <div className="space-y-6 animate-fade-in">
              <button onClick={() => setStep(1)} className="flex items-center gap-2 text-slate-400 hover:text-blue-600 text-sm font-bold transition-colors">
              ...
              <button 
                onClick={() => setStep(3)}
                disabled={!formData.email || !formData.adminPassword}
                className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white font-bold py-4 rounded-2xl transition-all shadow-lg shadow-blue-100"
              >
                Revisar e Finalizar
                <ArrowRight size={20} />
          ...
          {step === 3 && (
            <div className="space-y-6 animate-fade-in">
              <button onClick={() => setStep(2)} className="flex items-center gap-2 text-slate-400 hover:text-blue-600 text-sm font-bold transition-colors">
                <ChevronLeft size={18} /> Voltar
              </button>
              ...
              <div className="p-4 bg-amber-50 border border-amber-200 rounded-2xl flex gap-3 items-start">
                ...
                <p className="text-xs text-amber-800 leading-relaxed font-medium">
                  Ao clicar em finalizar, sua conta será criada. Um link de pagamento será gerado para que você possa ativar seu acesso após o período de teste.
                </p>
              </div>
              ...
              <button 
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white font-bold py-5 rounded-2xl transition-all shadow-xl shadow-emerald-100"
              >
                {loading ? <Loader2 className="animate-spin" /> : 'Finalizar e Ativar Conta'}
              </button>
            </div>
          )}
        </div>
